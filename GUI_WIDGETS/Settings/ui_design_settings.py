...
################################################################################
## Form generated from reading UI file 'design_settingsuPtlon.ui'
##
...
"}")
        ...
        self.p_wifi_title.setFrameShape(QFrame.StyledPanel)
        self.p_wifi_title.setFrameShadow(QFrame.Raised)
...
"border:none;")
        ...
        self.p_wifi_power.setFrameShape(QFrame.NoFrame)
        self.p_wifi_power.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_wifi_ip.setFrameShape(QFrame.StyledPanel)
        self.p_wifi_ip.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_wifi_ssid.setFrameShape(QFrame.StyledPanel)
        self.p_wifi_ssid.setFrameShadow(QFrame.Raised)
...
"background:gray;")
        ...
        self.p_bt_title.setFrameShape(QFrame.StyledPanel)
        self.p_bt_title.setFrameShadow(QFrame.Raised)
...
"border:none;")
        ...
        self.p_bt_power.setFrameShape(QFrame.NoFrame)
        self.p_bt_power.setFrameShadow(QFrame.Raised)
        ...
        self.frame_cb_2.setFrameShape(QFrame.StyledPanel)
        self.frame_cb_2.setFrameShadow(QFrame.Raised)
...
"	margin-bottom:1px;\n"
"}")
        self.a_border_5.setFrameShape(QFrame.StyledPanel)
        self.a_border_5.setFrameShadow(QFrame.Raised)
...
"background:gray;")
        ...
        self.p_bt_discoverable.setFrameShape(QFrame.NoFrame)
        self.p_bt_discoverable.setFrameShadow(QFrame.Raised)
        ...
        self.frame_cb_4.setFrameShape(QFrame.StyledPanel)
        self.frame_cb_4.setFrameShadow(QFrame.Raised)
...
"	margin-bottom:1px;\n"
"}")
        self.a_border_6.setFrameShape(QFrame.StyledPanel)
        self.a_border_6.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_bt_btName.setFrameShape(QFrame.StyledPanel)
        self.p_bt_btName.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_bt_btName_2.setFrameShape(QFrame.StyledPanel)
        self.p_bt_btName_2.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_status_title.setFrameShape(QFrame.StyledPanel)
        self.p_status_title.setFrameShadow(QFrame.Raised)
...
"background:none;")
        ...
        self.p_status_scrollArea.setFrameShape(QFrame.NoFrame)
        self.p_status_scrollArea.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_gpio_title.setFrameShape(QFrame.StyledPanel)
        self.p_gpio_title.setFrameShadow(QFrame.Raised)
...
"border:none;")
        ...
        self.p_gpio_setPin.setFrameShape(QFrame.StyledPanel)
        self.p_gpio_setPin.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_gpio_setPin_2.setFrameShape(QFrame.StyledPanel)
        self.p_gpio_setPin_2.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_systemInfo_scrollArea.setFrameShape(QFrame.StyledPanel)
        self.p_systemInfo_scrollArea.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_systemInfo_title.setFrameShape(QFrame.StyledPanel)
        self.p_systemInfo_title.setFrameShadow(QFrame.Raised)
...
"background:none;")
        ...
        self.p_terminal_title.setFrameShape(QFrame.StyledPanel)
        self.p_terminal_title.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.frame_page_advanced.setFrameShape(QFrame.StyledPanel)
        self.frame_page_advanced.setFrameShadow(QFrame.Raised)
        ...
        self.p_advanced_fastBoot.setFrameShape(QFrame.NoFrame)
        self.p_advanced_fastBoot.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_advanced_title.setFrameShape(QFrame.StyledPanel)
        self.p_advanced_title.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_advanced_autoPower.setFrameShape(QFrame.NoFrame)
        self.p_advanced_autoPower.setFrameShadow(QFrame.Raised)
...
"}")
        ...
        self.p_advanced_autoDiscoverable.setFrameShape(QFrame.NoFrame)
        self.p_advanced_autoDiscoverable.setFrameShadow(QFrame.Raised)
...
"}")
    ...
    def retranslateUi(self, Settings_widget):
        ...
        self.label_29.setText(QCoreApplication.translate("Settings_widget", u"Connected device name", None))
