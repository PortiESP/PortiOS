...
################################################################################
## Form generated from reading UI file 'ledsBHMyhC.ui'
##
...
"}")
        ...
        self.ledsProgramJumpButton.setFocusPolicy(Qt.NoFocus)
...
"}")
        ...
        self.ledsProgramFadeButton.setFocusPolicy(Qt.NoFocus)
...
"}")
        ...
        self.ledsProgramRandomButton.setFocusPolicy(Qt.NoFocus)
...
"}")
        ...
        self.ledsProgramFlashButton.setFocusPolicy(Qt.NoFocus)
...
"}")
        ...
        self.ledsProgramPoliceButton.setFocusPolicy(Qt.NoFocus)
