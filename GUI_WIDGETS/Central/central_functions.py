...
class Central_funcs:
	def centralSetup(self):
		...
		self.GUI_Central.footerButton_5.clicked.connect(lambda:Central_funcs.toogle_volume(self))
		self.GUI_Central.footerButton_6.clicked.connect(lambda:Central_funcs.toogle_power(self))

		# Power menu
		self.GUI_Central.powerCloseButton.clicked.connect(lambda:Central_funcs.toogle_power(self))
